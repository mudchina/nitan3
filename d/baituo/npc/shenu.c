...
void create()
{
	...
	set("long", "他是负责看管欧阳世家庄蛇场的蛇奴，担当替庄主、少主养育怪蛇的事务。\n");
	set("gender", "男性");
	set("title", "欧阳世家庄");
	set("age", 35);
...
void bring_snake(object me)
{
        ...
        if( new_breed > poison ) {
                ...
                snake->set_color("$HIW$");
                snake->set("long", 
                "一条银鳞闪闪的小蛇，形状怪异，是欧阳世家少主"+me->name()+"第"
...
int ask_guaishe()
{
	...
	if( me->query("family/family_name") != "欧阳世家" ) {
		command("say "+RANK_D->query_rude(me)+"想打听咱们欧阳世家的怪蛇，莫非动着什麽歪脑筋？");
		return 1;
	}
...
int do_order(string arg)
{
	...
	if( me->query("family/family_name") != "欧阳世家" ) return 0;
