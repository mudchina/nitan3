...
int effect_biao(object me, object target)
{
        ...
        myskill = (int) (2 * (int)me->query("dodge") + (atoi(me->query("combat_exp")) / 1000) + (int)me->uery_skill("tangmen-biaofa", 1));
        trskill = (int) (2 * (int)target->query("dodge") + (atoi(target->query("combat_exp")) / 1000));
