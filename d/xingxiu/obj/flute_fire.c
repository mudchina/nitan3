...
int do_kick(string arg){
        ...
        exp1=atoi(count_div(me->query("combat_exp"), 100));
        exp2=atoi(count_div(ob->query("combat_exp"), 100));
        ...
        if ((damage<150)){
                ...
                me->set_temp("die_reason", "给星宿毒火烧死了"); 
                ...
                if(random(exp1)>random(exp2))
                {
                        if( ob->query_temp("armor/cloth")){
                                ...
                                if( armor->query("id") != "armor") {
                                        ...
                                        armor->set_name("烧焦的" + armor->query("name"));
                                        armor->set("value", 0);
                        ...
                        message_vision(HIR"\n只听见一声惨叫，$n躲闪不及，被火焰烧中。\n"NOR,me,ob);
                        ob->set_temp("die_reason", "给星宿毒火烧死了"); 
