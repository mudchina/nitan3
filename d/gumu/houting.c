...
中只有一具棺材的棺板没有合上，棺材中好象空空如也。厅角
上摆放着一张石头做成的大床(chuang)。
LONG);
...
void reset()
{
     ...
     { 
              ...
              { 
                      ...
                      if (random(20) > 12) 
                      { 
tell_object(me,HIM"你调息完毕，只觉得精神健旺，内息充沛欲奔腾而出。\n"NOR );
                      ...
                      { 
tell_object(me,"你调息完毕，站起身来，提了提内力，好象没什么长进。\n" );
                              me->receive_damage("qi", 10 + random(10)); 
                      } 
              } else 
              { 
tell_object(me,"你躺上寒玉床，只觉得冰冷刺骨，‘啊’的一声狼狈不堪地跳了起来。\n" );
              } 
              return 1; 
      } 
