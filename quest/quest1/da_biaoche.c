...
{        
        ...
        {
                reward_exp1 = atoi(count_div(me->query("combat_exp"), 30000));
                ...
                reward_exp2 = atoi(count_div(parter->query("combat_exp"), 30000));
...
/*
                if (count_gt(parter->query("potential"), parter->query_potential_limit())) 
