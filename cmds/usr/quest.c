...
int main(object me, string arg)
{
    	 ...
    	 if(mapp(quest = me->query("bunch_quest")))
	 {
        ...
        if(me->query("questdg_times"))
    	         write("独孤求败交给你的任务，你已连续完成 "+me->query("questdg_times")+" 个了。\n");
        if(me->query("questkh_times"))
    	         write("葵花太监交给你的任务，你已连续完成 "+me->query("questkh_times")+" 个了。\n");
        if(me->query("questsn_times"))
    	         write("南海神尼交给你的任务，你已连续完成 "+me->query("questsn_times")+" 个了。\n");;
        if(me->query("quesths_times"))
	         write("黄裳交给你的任务，你已连续完成 "+me->query("quesths_times")+" 个了。\n");
