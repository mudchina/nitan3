...
int main(object me, string str)
{
        ...
        foreach (ob in ob_list)
        {
                ...
                delta = dbase["int"] - ob->query("gift/int/succeed") - ob->query("gift/water")
                      + dbase["con"] - ob->query("gift/con/succeed") - ob->query("gift/lighting")
                      + dbase["str"] - ob->query("gift/str/succeed") - ob->query("gift/sun")
                      + dbase["dex"] - ob->query("gift/dex/succeed") - ob->query("gift/feng") 
                      - 84;
