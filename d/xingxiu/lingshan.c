...
void create()
{
        ...
        set("short", "灵山");
        set("long", @LONG
从天池起步，攀上高插云霄、四时积雪的灵山。一到雪线附近，一股秋菊似
的幽香突然袭来，原来朵朵鲜花挺立在这寒风中，给冰雪世界增添了春色，这就
是被叫作 "高山玫瑰" 的雪莲。雪莲单单生长在这气候严寒、土质贫瘠的冰山雪
岭上，每年盛夏开花，一直开到深秋，不畏冰雪，即使在雪花纷飞中，依然吐苞
放瓣，敢於同雪花争艳，最终与茎同枯而不落。
LONG );
        set("exits", ([
...
int valid_leave(object me, string dir)
{
                ...
                || ( j > 0 ) )
        {
                ...
                message("vision", HIR"只见" + me->query("name") + "梭地一下从峰顶上直滑下来，差点儿掉进天池。\n"NOR, environment(me), me);
                if ( j > 0 )
                        for (i=0; i < sizeof(inv); i++) 
                        {
                                if ( !userp(inv[i]) &&
