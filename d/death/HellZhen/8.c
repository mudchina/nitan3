...
void create()
{
        ...
        set_skill("xiantian-gong", 1200);
        set_skill("quanzhen-xinfa", 1200);
        set_skill("finger", 1200);
        set_skill("zhongnan-zhi", 1200);
        set_skill("sword", 1200);
        set_skill("quanzhen-jian", 1200);
        set_skill("dodge", 1200);
        set_skill("jinyan-gong", 1200);
...
void invocation(object target)
{
        ...
        ap = me->query_skill("unarmed") * 3 / 2 + me->query("level") * 20 + 
