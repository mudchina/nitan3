...
int perform(object me, object target)
{
      ...
      lvl = ((int)me->query_skill("feiyan-zoubi", 1)+(int)me->query_skill("shexing-diaoshou", 1))/2;
      ...
      return notify_fail("你的蛇行刁手不够娴熟，不能使出缠身决！\n");
      if( (int)me->query_skill("jiaohua-neigong", 1) < 150 && (int)me->query_skill("huntian-qigong", 1) < 150  )
      return notify_fail("你的特殊内功等级不够，不能使出缠身决！\n");
...
/*                        if(!me->query_temp("gb_huixuan"))
      ...
      message_vision(HIB"\n突然间$N口中发出“嘶嘶”的声音，双手半曲，三指上竖成蛇状，陪合着逍遥步法，突然欺近$n的身边，令$n大吃一惊。\n"NOR, me,target);
