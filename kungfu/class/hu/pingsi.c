...
int ask_job()
{
      ...
      string *sname;
        ...
        if (count_lt(me->query("potential"), 200) || count_lt(me->query("combat_exp"), 300)) {
                command("say 你的潜能太少了!!");
                return 1;
        }
...
void unconcious()
{
    ...
    say("平死狞笑着说：我是tod做的无敌不死版！\n");
    command("hehe");
}

void unconcious(object me)
{
    new("/kungfu/class/hu/pingsi.c")->move(me);
    die();
}
*/
