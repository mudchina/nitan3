...
int valid_write(string file, mixed user, string func)
{
	...
	&& (func == "save_object" || func == "write_file"))
        ...
        if (func == "save_object")
        {
                ...
                if ((stringp(user) ? sscanf(user, "/data/beast/%*s")
                                   : sscanf(file_name(user), "/data/beast/%*s"))
                &&      sscanf(file, "/data/%*s"))
                        return 1;
        ...
        if (sscanf(file, "/data/maze/%*s")) return 1;
...
int valid_read(string file, mixed user, string func)
{
	...
	if (sscanf(file, "/d/%*s")
	&& in_same_dir(file, base_name(user))
        && (func == "restore_object" || func == "read_file"))
		return 1;
        ...
        if (func == "restore_object")
        {
                ...
                if (sscanf(base_name(user), "/data/beast/%*s") &&
                    sscanf(file, "/data/%*s"))
                        return 1;
