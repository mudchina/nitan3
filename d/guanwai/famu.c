...
int working(object me)
{
        ...
        if (finish)
        {
                ...
                if (count_ge(me->query("combat_exp"), 500000) &&
                    count_lt(me->query("combat_exp"), 1000000))
                {
                        // bonus to me
                        b = 150 + random(100);
                        me->add("combat_exp", b);
                        // me->improve_potential((b + 2) / 2);
                ...
                if (count_ge(coagent->query("combat_exp"), 500000) &&
                    count_lt(coagent->query("combat_exp"), 1000000))
                {
                        // bonus to coagent
                        b = 150 + random(100);
                        coagent->add("combat_exp", b);
                        // coagent->improve_potential((b + 2) / 2);
                        coagent->add("potential", b / 2);
