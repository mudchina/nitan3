...
/*
        else if (mp >= 100)
        {
                ...
                {
                case 0:
                        result += (["msg" : HIY "$n身前仿佛有一道无形气墙，但$N早已看破$n的诡计，直攻其要害。\n" NOR]);
                        break; 
                case 1:
                        result += (["msg" : HIY "$n浑若无事的接下了这一招，却意外地受到了伤害。\n" NOR]);
                        break; 
                case 2:
                        result += (["msg" : HIY "可是$N看出了$n的金刚不坏的气门所在，招式变幻莫测，双手遥指$n气门,$n心里一慌，真气流畅不顺，露出了破绽。\n" NOR]);
                        break; 
                default: 
                        result += (["msg" : HIY "只见$N这一招打了个正中！大喝一声“破！”，结果正中$n要害。\n" NOR]);
                        break; 
                } 
