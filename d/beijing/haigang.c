...
void create()
{
        set("short", "东海之滨");
        set("long", @LONG
这里是大海之滨，浪花拍打着礁石，发出阵阵响声，海面上一群群海鸥『欧
欧..』地叫着，不时有鱼儿跃出海面，溅起层层的浪花。边上有艘大船(chuan)， 
船上坐着几个渔夫打扮的人，乘船可渡过大海到达海的另一端。西面一直走就是
燕京了，东面是一望无际的大海。极目眺望不禁让人心胸开扩，神舒意畅，的确
是一个好居处。
LONG );
        set("exits", ([
...
void init()
{
        ...
        if (objectp(dao))
        {
                ...
                message_vision(HIC "你看见沙滩上停泊满了海船，所有的海船全部标记着天鹰教的标记。\n"NOR, me);
