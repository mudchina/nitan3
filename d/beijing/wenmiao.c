...
void create()
{
	set("short", "文庙");
        set("long", @LONG
这里是文庙正殿，内有孔夫子像。历代皇帝都懂得利用儒教思想来巩固自己
的江山社稷，当朝皇帝自然也不例外。不论何人到此，都毕恭毕敬地上香礼拜。
孔夫子讲究的是人的悟性，要成为一位扬名天下的大侠，光靠武力往往不能做到，
还需要有足够的智慧。不少江湖中流名千古的神话人物，在初入江湖时，都曾经
在这里发下誓言，虔诚的膜拜(mobai)。 新玩家也可以在这里抽签(chouqian)，
明确一下自己的性格，踏上漫漫江湖路。
LONG );
