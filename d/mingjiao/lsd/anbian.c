...
void create()
{
        ...
        set("long", @LONG
只见岸边数里之外树木葱翠，奇峰挺拔，耸立着好几座高山。岛东端
山石直降人入海，并无浅滩，帆船吃水较深，却可以泊在岸边。这时你看
见不远的有一块颇为平整的岩石，上面被人用利器刻着“灵蛇岛”三个大
字，其侧还有几个看不太清的小字(zi)。往东而上是一个很高的山岗，再
上面是一座山峰。海滩上有几只海船，看来可以推(tui)下海去。
LONG );
        set("exits", ([ 
