...
int main(object me, string arg)
{
	...
	if (me->is_busy())
        ...
        if (count_lt(count_sub(me->query("potential"), me->query("learned_points")), 1000))
...
int outing(object me)
{
        ...
        if (count_le(me->query("potential"), me->query("learned_points")))
        {
...
int halt_outing(object me)
{
        ...
        me->add("potential", count_div(count_sub(me->query("learned_points"), me->query("potential")), 2));
