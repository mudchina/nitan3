...
void create()
{
        ...
        set_skill("xiaowuxiang", 1200);
        set_skill("beiming-shengong", 1200);
        set_skill("dodge", 1200);
        set_skill("lingbo-weibu", 1200);
        set_skill("feiyan-zoubi", 1200);
        set_skill("strike", 1200);
        // set_skill("panyang-zhang", 1200);
        set_skill("liuyang-zhang", 1200);
        set_skill("hand", 1200);
        set_skill("qingyun-shou", 1200);
        set_skill("zhemei-shou", 1200);
        set_skill("parry", 1200);
        set_skill("sword", 1200);
        set_skill("liuyue-jian", 1200);
        set_skill("blade", 1200);
        set_skill("ruyi-dao", 1200);
        set_skill("literate", 1200);
        set_skill("medical", 1200);
        set_skill("xiaoyao-qixue", 1200);
        set_skill("mathematics", 1200);
        set_skill("qimen-wuxing", 1200);
        set_skill("drawing",   1200);
        set_skill("chuixiao-jifa", 1200);
        set_skill("tanqin-jifa", 1200);
        set_skill("chess", 1200);
        set_skill("calligraphy", 1200);
