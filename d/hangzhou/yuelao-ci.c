...
void create(){
	set("short", "月老祠");
	set("long", @LONG
月老是神话中掌管姻缘的仙人，传说他有红线，若把它系在男女朋方的脚上，
虽仇人或相隔千里，终会结成姻缘。月老祠一间小院、三五瓦屋。正屋中央的神
龛里坐着月下老人：红风帽红披肩，鹤发童颜，笑容满面。神龛前面照例是供桌、
香炉、烛台、签筒，当然，蒲团也是少不了的。两旁一副黑漆的小对联：愿天下
有情人，都成了眷属；是前生注定事，莫错过姻缘。令人拍案叫绝。你可以在这
里求签（qiuqian）问一下姻缘情事。
LONG );
	set("no_fight", "1");
	set("no_steal", "1");
