...
*/
        ...
        {
                damage = ((mybili+mywx) * (5 + (int)me->query_skill("staff")/80) ) ;
                if(damage > 2500) damage = 2500;
                if(damage < 500) damage = 500;

                target->receive_damage("qi", damage,  me);
                target->receive_wound("qi", (int)me->query_skill("staff"), me);
                me->start_busy(2);
