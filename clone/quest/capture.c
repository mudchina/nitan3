...
string ask_npc1(object knower, object me)
{
        ...
        if (count_lt(me->query("combat_exp"), count_div(NPC1->query("combat_exp"), 2)))
        {
...
string ask_npc2(object knower, object me)
{
        ...
        if (count_lt(me->query("combat_exp"), count_div(NPC2->query("combat_exp"), 2)))
        {
...
*/
        ...
        if (count_lt(me->query("combat_exp"), count_div(NPC3->query("combat_exp"), 2)))
        {
