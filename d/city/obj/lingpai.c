...
int do_catch(string arg)
{
        ...
        if ((int)me->query_temp("kf_whatnpc")==1)  new_obj = new("/d/kaifeng/npc/tufei1.c");
    if ((int)me->query_temp("kf_whatnpc")==2)  new_obj = new("/d/kaifeng/npc/tufei2.c");
    if ((int)me->query_temp("kf_whatnpc")==3)  new_obj = new("/d/kaifeng/npc/tufei3.c");
    if ((int)me->query_temp("kf_whatnpc")==4)  new_obj = new("/d/kaifeng/npc/tufei4.c");
    if ((int)me->query_temp("kf_whatnpc")==5)  new_obj = new("/d/kaifeng/npc/tufei5.c");
    if ((int)me->query_temp("kf_whatnpc")==6)  new_obj = new("/d/kaifeng/npc/tufei6.c");
    if ((int)me->query_temp("kf_whatnpc")==7)  new_obj = new("/d/kaifeng/npc/tufei7.c");
    if ((int)me->query_temp("kf_whatnpc")==8)  new_obj = new("/d/kaifeng/npc/tufei8.c");
