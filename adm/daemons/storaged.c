...
int CancelAccount(object me)
{
        ...
        else 
        {
                ...
                if(sizeof(m)==0)
                {
                        ...
                        log_file("storage.log","cancel:"+me->query("name")+"("+me->query("id")+")取消了帐户！类型："+m["typ"]+"\n");
...
int OpenAccount(object me,string arg)
{
        ...
        if(k)
        {
                ...
                log_file("storage.log","open:"+me->query("name")+"("+me->query("id")+")开设了第"+i+"类帐户！\n");
...
int DoFee(object me,string arg)
{
    ...
    if(k)
    {
            ...
            log_file("storage.log","open:"+me->query("name")+"("+me->query("id")+")为第"+i+"类帐户续了"+mon+"个月！\n");
